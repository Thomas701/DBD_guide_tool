...
export const conditionLabels: Record<KnownConditionType, string> = {
  ...
  chase_abandoned: "Poursuite abandonnée",
  ...
  generator_at_70_percent: "Générateur à 70 %",
  ...
  blood_pool_present: "Flaque de sang présente",
  ...
  blind_attempted: "Aveuglement",
  after_break_action: "Après une action de destruction",
  pallet_stunned: "Étourdi par une palette",
